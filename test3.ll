; ModuleID = 'test3.26ab1ff8e14968d6-cgu.0'
source_filename = "test3.26ab1ff8e14968d6-cgu.0"
...
start:
  ...
  %_3.i = load i128, ptr %other, align 16, !alias.scope !7, !noalias !4, !noundef !9
  %0 = load i128, ptr %self, align 16, !alias.scope !4, !noalias !7, !noundef !9
  %1 = and i128 %0, %_3.i
  store i128 %1, ptr %self, align 16, !alias.scope !4, !noalias !7
...
define void @bitand_assign(ptr noalias nofree noundef align 16 captures(none) dereferenceable(16) %self, ptr noalias nofree noundef readonly align 16 captures(none) dereferenceable(16) %other) unnamed_addr #1 {
start:
...
!4 = !{!5}
!5 = distinct !{!5, !6, !"bitand_assign: %self"}
!6 = distinct !{!6, !"bitand_assign"}
!7 = !{!8}
!8 = distinct !{!8, !6, !"bitand_assign: %other"}
!9 = !{}
